...
describe('React Hooks', () => {
  ...
  describe('useRecording', () => {
    ...
    it('should create session', async () => {
      ...
      expect(eyeAnalysis.createSession).toHaveBeenCalledWith(sessionConfig, undefined)
  ...
  describe('useGazeTracking', () => {
    ...
    it('should add user event', async () => {
      ...
      expect(eyeAnalysis.addEvent).toHaveBeenCalledWith('user_interaction', eventData)
